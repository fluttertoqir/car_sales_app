...
abstract class _LogicProvider with Store {
  ...
  void changeIconOfFavarite(int index) {
    (IconList[index].icon == Icon(Icons.favorite, color: Colors.pink).icon)
        ? IconList[index] = Icon(Icons.favorite_border_rounded)
        : IconList[index] = Icon(Icons.favorite, color: Colors.pink);
  }
